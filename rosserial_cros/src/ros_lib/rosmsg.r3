...
func rosmsg_write_uint16(var string[] outbuf, int offset, int value)
    str_chr_set(outbuf, offset, value & 0xFF)
    str_chr_set(outbuf, offset + 1, (value >> 8) & 0xFF)
    return offset + 2
end func

func rosmsg_read_uint16(var string[] inbuf, int offset, var int value)
    value  = str_chr_get(inbuf, offset)
    value |= str_chr_get(inbuf, offset + 1) << 8
    return offset + 2
end func

func rosmsg_write_int32(var string[] outbuf, int offset, int value)
    str_chr_set(outbuf, offset, value & 0xFF)
    str_chr_set(outbuf, offset + 1, (value >> 8) & 0xFF)
...
func rosmsg_read_int32(var string[] inbuf, int offset, var int value)
    value  = str_chr_get(inbuf, offset)
    value |= str_chr_get(inbuf, offset + 1) << 8
...
func rosmsg_write_float32(var string[] outbuf, int offset, float value)
    union
        int ival
        float fval
    end union tmp
...
func rosmsg_read_float32(var string[] inbuf, int offset, var float value)
    union
        int ival
        float fval
    end union tmp
...
func rosmsg_write_float64(var string[] outbuf, int offset, float value)
    union
        int ival
        float fval
    end union tmp
...
func rosmsg_read_float64(var string[] inbuf, int offset, var float value)
    int mantissa
    int exponent
...
func rosmsg_write_string(var string[] outbuf, int offset, var string[] value)
    int len = strlen(value)
    offset = rosmsg_write_int32(outbuf, offset, len, 4)
    str_edit(outbuf, value, offset, len)
    return offset + len
end func

func rosmsg_read_string(var string[] inbuf, int offset, var string[] value)
    int len
    offset = rosmsg_read_int32(inbuf, offset, len, 4)
